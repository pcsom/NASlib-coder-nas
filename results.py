...
file_paths = {
    ...
    "Bananas (Default)": f"/home/hice1/psomu3/scratch/codenas/NASLib/{run}/{space}/{dataset}/CustomXGBoost_bananas/{seed}/errors.json",
    "Bananas + LLM (Ours)": f"/home/hice1/psomu3/scratch/codenas/NASLib/{run}/{space}/{dataset}/{llm_pred}/{seed}/errors.json"
}

output_filename = "search_trajectory_comparison"
