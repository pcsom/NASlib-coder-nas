...
directory_path10 = 'run_nb201/run_nb201/nasbench201/cifar10/CustomXGBoost_bananas'
directory_path100 = 'run_nb201/run_nb201/nasbench201/cifar100/CustomXGBoost_bananas'
...
for arch_index in arch_dict_100:
    if arch_index not in arch_dict_10:
        data_combined.append({      "arch_index": arch_index,       "predicted_accuracy_cifar10": -1000,       "generation_firstdiscovery_cifar10": -1000,       "generation_lastdiscovery_cifar10": -1000,       "predicted_accuracy_cifar100": arch_dict_100[arch_index]["predicted_accuracy"],       "generation_firstdiscovery_cifar100": arch_dict_100[arch_index]["generation_firstdiscovery"],       "generation_lastdiscovery_cifar100": arch_dict_100[arch_index]["generation_lastdiscovery"],       "average_predicted_accuracy_cifar10": -1000,       "average_generation_cifar10": -1000,       "average_predicted_accuracy_cifar100": arch_dict_100[arch_index]["average_predicted_accuracy"],       "average_generation_cifar100": arch_dict_100[arch_index]["average_generation"],       "showed_up_cifar10": -1000,       "showed_up_cifar100": arch_dict_100[arch_index]["showed_up"]        })
...
df_unified.to_csv('/storage/ice-shared/vip-vvk/data/AOT/mgullapalli6/codenas/collecteddata_unified80.csv', index=False)